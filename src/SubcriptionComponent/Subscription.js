            ...
            <div className='section-6'>
                <div className='subscription'>
                    <div className='subscription-card'>
                        <div className='subscription-card-flx'>
                            <div className='subscription-card-flx-free-trial'>
                                <div className='subscription-card-flx-free-trial-heading'>
                                    <h1>
                                        Start your <br/> <span className='subscription-card-flx-free-trial-bold'>Free Trial</span> today
                                    </h1>
                                </div>
                            ...
                            <div className='subscription-card-flx-1month'>
                                <div className='subscription-card-flx-1month-heading'>
                                    <p className='subscription-card-flx-1month-heading-txt ftsize-dollor-height ftsize-heading'>1 Month <br />
                            ...
                            <div className='subscription-card-flx-3month'>
                                <div className='subscription-card-flx-3month-heading'>
                                    <p className='subscription-card-flx-3month-heading-txt ftsize-dollor-height ftsize-heading'>3 Month <br />
                            ...
                            <div className='subscription-card-flx-unlimited'>
                                <div className='subscription-card-flx-unlimited-heading'>
                                    <p className='subscription-card-flx-unlimited-heading-txt ftsize-dollor-height ftsize-heading'>Unlimited <br />
                            ...
                            <div className='subscription-card-flx-12month'>
                                <div className='subscription-card-flx-12month-heading'>
                                    <p className='subscription-card-flx-12month-heading-txt ftsize-dollor-height ftsize-heading'>12 Month <br />
